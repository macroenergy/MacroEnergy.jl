...
# planning_sol = MacroEnergySolvers.solve_planning_problem(planning_problem,linking_variables);

# subop_sol = MacroEnergySolvers.solve_operation_subproblems(subproblems,planning_sol);
