...
# Timeseries Results for Cement

i = 1
cement_plant_results = DataFrame(
    cement_materials_edge = Macro.value.(Macro.flow(system.assets[i].cement_materials_edge)).data,
...
Macro.write_csv(joinpath(results_dir, "cement_plant_results.csv"), cement_plant_results)

# cement_production_results = DataFrame(cement_edge = Macro.value.(Macro.flow(system.assets[i].cement_edge)).data)
# Macro.write_csv(joinpath(results_dir, "cement_production_results.csv"), cement_production_results)
