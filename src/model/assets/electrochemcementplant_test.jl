...
ElectrochemCementPlant_test(id::AssetId, cement_transform::Transformation, elec_edge::Union{Edge{Electricity},EdgeWithUC{Electricity}}, echem_cement_edge::Edge{Cement}) = 
ElectrochemCementPlant_test{Nothing}(id, cement_transform, elec_edge, echem_cement_edge)
...
function make(::Type{ElectrochemCementPlant_test}, data::AbstractDict{Symbol,Any}, system::System)
    ...
    return ElectrochemCementPlant_test(id, cement_transform, elec_edge, echem_cement_edge)
end
